$(document).ready(function () {
    ...
    var faults = $.ajax({
        url: "http://localhost:4500/faultDetectionGIS/Fault_GIS_AI_App/experiments/expapi.php",
        dataType: "json",
    ...
    var roads = $.ajax({
        url: "http://localhost:4500/faultDetectionGIS/Fault_GIS_AI_App/api/roads.php",
        dataType: "json",
