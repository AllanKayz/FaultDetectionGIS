...
foreman = {
    ...
    initStatistics: function () {
        ...
        //Current faults ajax
        $.ajax({
            url: 'http://localhost:4500/faultDetectionGIS/Fault_GIS_AI_App/server/stats.php?action=currentfaults',
            type: 'GET',
        ...
        //Damage reports ajax
        $.ajax({
            url: 'http://localhost:4500/faultDetectionGIS/Fault_GIS_AI_App/server/stats.php?action=damagereports',
            type: 'GET',
            success: function (data) {
                data = JSON.parse(data);
                console.log(data)
        ...
        var auto_refresh = setInterval(
            function () {
                $.ajax({
                    url: 'http://localhost:4500/faultDetectionGIS/Fault_GIS_AI_App/experiments/changecontent.php',
                    type: 'POST',
                    data: money,
                    dataType: 'html',
                    success: function (data) {
